...
class ResetPIN:
    ...
    # def amount(self,app,aa):
    #     print("first acc data :: ")
    #     print(self.acc_data.get())
    #     self.user_pin(self.app)
    #     print("uigukgkgkgkgkgk")
    #     # print(self.app,self.aa)
